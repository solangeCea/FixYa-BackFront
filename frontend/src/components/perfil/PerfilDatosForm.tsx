...
// Formulario de edición de datos personales, compartido por el perfil del
// técnico y del cliente (mismos campos y validaciones).
function PerfilDatosForm({
  usuario,
  setUsuario,
  title = "Información personal",
  description = "Actualiza tu información de contacto y ubicación.",
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-5">
          <div>
            ...
            <input
              ...
              placeholder="Ej: Sofía Contreras Rojas"
