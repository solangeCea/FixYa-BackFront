...
import { AlertCircle, CheckCircle2, Save, UserCog } from "lucide-react";
...
export default function AdminPerfil() {
  ...
  function validar() {
    ...
    if (!form.region_id_region) nextErrors.region_id_region = "Selecciona tu región.";
    if (!form.comuna_id_comuna) nextErrors.comuna_id_comuna = "Selecciona tu comuna.";
      ...
      <header className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-slate-600">
            Actualiza tu información personal y de acceso.
          </p>
        </div>
      </header>
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
        ...
        {loadingCatalogos || !usuario ? (
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            <div>
              <label htmlFor="nombre_completo" className="mb-2 block text-sm font-bold text-slate-700">
              ...
              <input
                ...
                placeholder="Ej: Administrador FixYa"
            ...
            <div>
              <label htmlFor="correo" className="mb-2 block text-sm font-bold text-slate-700">
            ...
            <div>
              <label htmlFor="confirmarCorreo" className="mb-2 block text-sm font-bold text-slate-700">
              ...
              <input
                ...
                placeholder={correoCambio ? "Repite tu nuevo correo" : "Solo si modificas tu correo"}
            ...
            <div>
              <label htmlFor="telefono" className="mb-2 block text-sm font-bold text-slate-700">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                <label htmlFor="region_id_region" className="mb-2 block text-sm font-bold text-slate-700">
              ...
              <div>
                <label htmlFor="comuna_id_comuna" className="mb-2 block text-sm font-bold text-slate-700">
            ...
            <div>
              <label htmlFor="direccion" className="mb-2 block text-sm font-bold text-slate-700">
                Dirección{" "}
